...
* exposes a **FastAPI** endpoint (`/NDVI`) for real-time scoring, and
...
│   ├── api.py             # /NDVI endpoint + validation
...
Then, access the interactive API documentation at [http://0.0.0.0:8034/docs#/](http://0.0.0.0:8000/docs#/) to explore the `/NDVI` endpoint and other routes.
