...
* exposes a **FastAPI** endpoint (`/seed`) for real-time scoring, and
...
│   ├── api.py             # /seed endpoint + validation
...
Then, access the interactive API documentation at [http://0.0.0.0:8038/docs#/](http://0.0.0.0:8000/docs#/) to explore the `/seed` endpoint and other routes.
