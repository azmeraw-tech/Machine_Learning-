...
* exposes a **FastAPI** endpoint (`/Yield_Prediction`) for real-time scoring, and
...
│   ├── api.py             # /Yield_Prediction endpoint + validation
...
Then, access the interactive API documentation at [http://0.0.0.0:8044/docs#/] to explore the `/Yield_Prediction` endpoint and other routes.
